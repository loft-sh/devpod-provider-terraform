...
var checksumMap = map[string]string{
	"./release/devpod-provider-terraform-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-terraform-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-terraform-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-terraform-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-terraform-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
